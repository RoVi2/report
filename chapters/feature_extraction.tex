...
The goal of this chapter is to explain how the ball used as the target object is detected in both images. 
With these positions the stereopsis can be computed as explained in \ref{chap:stereopsis} and hence the 3D position of the ball in the world can be obtained.
The tracking of the object is a function implemented inside the node "balltracker" explained in section \ref{chap:ros_nodes_structure}.
